...
public class ObjectPoolManager : MonoBehaviour {
    ...
    public static void ReturnObjectDelayed(GameObject activeObject, float delayTime)
    {
        _instance.StartCoroutine(_instance.DelayReturn(activeObject, delayTime));
    }

    IEnumerator DelayReturn(GameObject activeObj, float time)
    {
